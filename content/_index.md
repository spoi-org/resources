...
**If you're a beginner, go to [the getting started guide]({{< ref "getting-started.md" >}})**.
...
You can find a list of all editorials available on this website [here](/editorials). This list is automatically updated as new problems and articles are added.